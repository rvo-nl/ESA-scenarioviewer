...
function drawSelectionButtons (config) {
  ...
  function drawScenarioButtons () {
    let scenarios = [
      ...
      {id: 'PBL.WLO1', title: 'PBL | WLO | Hoog Snel', color: colorWLO},
      {id: 'PBL.WLO2', title: 'PBL | WLO | Laag Snel', color: colorWLO},
      {id: 'PBL.WLO3', title: 'PBL | WLO | Hoog Vertraagd', color: colorWLO},
      {id: 'PBL.WLO4', title: 'PBL | WLO | Laag Vertraagd', color: colorWLO},
