...
function drawSelectionButtons (config) {
  ...
  function drawScenarioButtons () {
    let scenarios = [
      ...
      {id: 'NBNL.V3KM', title: 'NBNL | 2025 | Koersvaste Middenweg', color: colorNBNLv3},
      {id: 'NBNL.V3EM', title: 'NBNL | 2025 | Eigen Vermogen', color: colorNBNLv3},
      {id: 'NBNL.V3GB', title: 'NBNL | 2025 | Gezamenlijke Balans', color: colorNBNLv3},
