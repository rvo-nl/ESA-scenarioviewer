...
//   sankeyfy({
//     mode: 'xlsx',
//     xlsxURL: '/private/sankeydata.xlsx',
...
// Global states
// TENNET version: Initialize with PBL.PR40 instead of nat/ADAPT
let currentScenario = 'PBL.PR40'
...
xlsxToJSON('private/data_watervaldiagram_B_TRANSFORM - Competitief en import.xlsx')
  ...
  xlsxToJSON('private/data_watervaldiagram_PP_CCS_30_in_2050.xlsx')
...
xlsxToJSON('private/data_watervaldiagram_OP - CO2-opslag 40.xlsx')
  ...
  function initWaterfallDiagram () {
    // Draw waterfall diagrams with PR40 dataset (first TVKN scenario) using different configurations
    drawWaterfallDiagram(dataset_PR40, {
      divID: 'opbouw',
